...
$raw_from = get_field('promo_date_from');
$raw_to = get_field('promo_date_to');
      ...
      <div class="promo-card__dates">
        <?php if ($formatted_from && $formatted_to): ?>
          <span class="promo-card__date-range">
            ...
            <span>
              <?= esc_html($formatted_from); ?> – <?= esc_html($formatted_to); ?>
            </span>
          </span>
        <?php elseif ($formatted_from): ?>
          <span class="promo-card__date-from">
            <?= esc_html($formatted_from); ?>
          </span>
        <?php elseif ($formatted_to): ?>
          <span class="promo-card__date-to">
