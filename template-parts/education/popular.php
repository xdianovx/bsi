...
if (!$use_test_data) {
    ...
    if (function_exists('bsi_homepage_slider_limit')) {
        $education_limit = bsi_homepage_slider_limit('education');
        if ($education_limit > 0) {
            $popular_education_ids = array_slice($popular_education_ids, 0, $education_limit);
        }
    }
...
if ($use_test_data || empty($items)) {
    ...
    $test_items = [
        [
            ...
            'image' => 'http://www.bsistudy.ru/upload/resize_cache/tour/3/e/0/640_410_2/3e0fd1a965b4ba16188364fd561738bf.jpg',
        ...
        [
            ...
            'image' => 'http://www.bsistudy.ru/upload/tour/1/8/b/18b8ba5ab26aaaaf7217341bf8f753bc.jpg',
        ...
        [
            ...
            'image' => 'http://www.bsistudy.ru/upload/resize_cache/tour/b/8/4/640_410_2/b84cd42b2093a94c73cfb9513321f6bf.jpg',
        ...
        [
            ...
            'image' => 'http://www.bsistudy.ru/upload/resize_cache/tour/2/c/e/640_410_2/2ce95308a6d57f51a1d43b02738c0431.JPG',
...
// Формируем список стран для фильтра из массива $items (fallback когда $promo_countries пуст)
$filter_countries = [];

if (empty($promo_countries) && !empty($items)) {
    $countries_map = [];
                ...
                <div class="swiper popular-education-slider">
                    <div class="swiper-wrapper">
                        <?php foreach ($items as $item): ?>
                            <?php
                            $data_country = !empty($item['country_id'])
                                ? (string) $item['country_id']
                                : (string) $item['country_title'];
                            $data_country_slug = !empty($item['country_slug'])
