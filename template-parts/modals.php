<div class="modal micromodal-slide" id="modal-hotel-pdf">
    ...
    <div class="modal__container">
      ...
      <form action="" class="modal__form">
        <div class="input-item">
          ...
          <input type="text" name="agency" id="agency" placeholder="Название агенства">

          <div class="error-message" data-field="agency">
          </div>
        </div>
        <div class="input-item">
          <label for="name">Имя</label>
          <input type="text" name="name" id="name" placeholder="Почта">
        ...
        if (function_exists('bsi_render_privacy_consent_checkbox')) {
          bsi_render_privacy_consent_checkbox([
            'variant' => 'visa-page',
            'checkbox_id' => 'modal-hotel-privacy',
            'html_required' => true,
          ]);
        }
        ?>
        <div class="modal-form__botom">
          ...
          <button type="submit" class="btn btn-accent">Отправть</button>
