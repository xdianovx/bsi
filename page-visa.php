  ...
  <section class="page-head archive-page-head">
    <div class="container">
      <div class="archive-page__top">
        ...
        <p class="visa-disclaimer">Визовое сопровождение и поддержка c 93% одобрением в более чем 12 направлений
          с 1990
          года</p>
      </div>
    </div>
        ...
        <div class="visa-info-item__wrap">
          ...
          <div class="visa-info-item">
            ...
            <div class="visa-info-item__value">
              ...
              <a class="visa-info-mail" href="mailto:o.lukashova@bsigroup.ru">o.lukashova@bsigroup.ru</a>
            </div>
          </div>
