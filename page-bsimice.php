...
while (have_posts()) :
  ...
  $reviews_acf = function_exists('get_field') ? get_field('bsimice_reviews') : null;
  $reviews_from_acf = !empty($reviews_acf) && is_array($reviews_acf);
  $reviews = $reviews_from_acf ? $reviews_acf : $bsimice_defaults['reviews'];
...
<main class="bsimice-page">
        ...
        <section class="hero">
            <div class="container">
                <div class="hero__top">
                    ...
                    <p class="hero__subtitle"><?php echo $hero_subtitle_html; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
        ...
        <div class="container">
            <div class="plates">
                <?php foreach ($plates as $plate) :
                  ...
                  ?>
                <div class="plate">
                    <span class="plate__text"><?php echo bsimice_format_textarea($ptext, $plates_from_acf); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></span>
                </div>
                <?php endforeach; ?>
            </div>
        </div>
    ...
    <section class="mice-about">
        <div class="container">
            ...
            <p class="mice-about__subtitle"><?php echo $about_subtitle_html; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
            ...
            <div class="mice-about__items">
                ...
                <div class="mice-about__item">
                    <p class="mice-about__item-title"><span><?php echo esc_html($letter); ?></span><?php echo esc_html($title_rest); ?></p>
                    <span class="mice-about__item-desc"><?php echo bsimice_format_textarea($desc, $about_items_from_acf); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></span>
                </div>
                <?php endforeach; ?>
            </div>
        </div>
                ...
                <div class="mice-proove__content">
                    ...
                    <div class="mice-proove__body">
                        <?php foreach ($prove_paragraphs as $row) :
                          ...
                          ?>
                        <p><?php echo bsimice_format_textarea($p, $prove_paragraphs_from_acf); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
                        <?php endforeach; ?>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="services__list">
                ...
                <div class="services__item">
                    ...
                    <div class="services__item-desc"><?php echo bsimice_format_textarea($sdesc, $services_from_acf); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></div>
                </div>
                <?php endforeach; ?>
            </div>
            <div class="services__guarantees">
                ...
                <div class="services__guarantee">
                    ...
                    <div class="services__guarantee-box"><?php echo bsimice_format_textarea($gx, $guarantees_from_acf); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></div>
                </div>
                <?php endforeach; ?>
            </div>
        </div>
            ...
            <div class="swiper new-reviews-swiper">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="slide_box">
                            <p class="review_text"><?php echo bsimice_format_textarea($quote, $reviews_from_acf); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
