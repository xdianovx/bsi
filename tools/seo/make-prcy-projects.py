...
Группа = раздел по-русски, без страны: «Экскурсии», «Туры», «Отели» и так далее,
12 групп на всю семантику. Страну в группу не добавляем — по большинству стран
у нас 1-2 запроса, и связка «раздел + страна» рассыпалась на две сотни групп
по одному запросу. Страна, интент и сезон остаются в размеченном CSV, он и есть
...
# человекочитаемые имена групп; ключи — значения колонки «Раздел»
SECTION_TITLES = {
    'tour':      'Туры',
    'excursion': 'Экскурсии',
    'hotel':     'Отели',
    ...
    'visa':      'Визы',
    'education': 'Обучение',
    'event':     'Событийные туры',
    'cruise':    'Круизы',
    'insurance': 'Страхование',
    'agency':    'Турагентствам',
    'mice':      'MICE и бизнес-туры',
    'brand':     'Брендовые',
    'other':     'Прочее',
}
...
def make_grouper(rows):
    """Группа = раздел по-русски. Страна в группу не идёт — см. модуль-док."""
    def group_of(r):
        return SECTION_TITLES.get(r['Раздел'], r['Раздел'])
