...
$countries = [
  ...
  'jpn' => [
    ...
    /* S_SUBTYPE у всех японских записей = 0, запасной раскладки нет. */
    'subtype_regions' => [],
  ],
  'kor' => [
    'legacy_id' => 48963341,
    ...
    /* S_SUBTYPE у корейских записей = 0; у четырёх город ссылается
       на несуществующий t_cities 100176450 — они останутся без региона. */
    'subtype_regions' => [],
  ],
  'fra' => [
    'legacy_id' => 30,
