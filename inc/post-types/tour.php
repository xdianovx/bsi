...
add_action('acf/init', function () {
  ...
  acf_add_local_field_group([
    ...
    'fields' => [
      ...
      [
        'key' => 'field_tour_show_price_from',
      ...
      [
        'key' => 'field_tour_excursions_count',
        'label' => 'Количество экскурсий',
        'name' => 'tour_excursions_count',
        'type' => 'number',
        'wrapper' => ['width' => '50'],
        'placeholder' => 'Например: 5',
        'instructions' => 'Количество экскурсий в туре',
      ],
    ],
    'location' => [
      [
