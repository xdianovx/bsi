...
function bsi_seo_page_titles(): array
{
    return [
        ...
        'kruizy' => 'Круизы — морские и речные маршруты, цены и даты',
        'strahovanie' => 'Страхование путешественников — полисы и цены',
        'turagenstvam' => 'Турагентствам — документы, обучение и сотрудничество',
        'bonusnaya-programma' => 'Бонусная программа для турагентств — комиссия и выплаты',
        'gde-kupit' => 'Где купить туры BSI Group — офисы и агентства-партнёры',
        'fit' => 'Индивидуальные туры под заказ — маршрут, отели, трансферы',
        'business' => 'Деловой туризм — MICE, командировки и корпоративные поездки',
        'business/bsimice' => 'BSI MICE — организация корпоративных мероприятий под ключ',
        'kontakty' => 'Контакты BSI Group — офисы, телефоны и режим работы',
    ];
}
