 ...
 * В карту попадают каталоги стран, страницы курортов и отели, у которых есть
 * номера. По цене отбирать нельзя: хаб тянет её у поставщика при первом
 * обращении к карточке, так что до визита её и не будет.
 */
