...
add_action('acf/init', function () {
			...
			[
				...
				'sub_fields' => [
					...
					[
						...
						'label' => 'Лимит или условие',
						'name' => 'limit',
						'type' => 'text',
						'instructions' => 'Короткая приписка справа от пункта: «до 150 у.е.», «только «Все включено»». Необязательно.',
						'wrapper' => ['width' => '30'],
					],
				],
			],
	...
	acf_add_local_field_group([
		...
		'fields' => [
			...
			[
				'key' => 'field_insurance_tab_claim',
				'label' => 'Страховой случай',
				'type' => 'tab',
				'placement' => 'top',
			],
			[
				'key' => 'field_insurance_claim_title',
				'label' => 'Заголовок блока',
				'name' => 'insurance_claim_title',
				'type' => 'text',
				'placeholder' => 'Что делать при страховом случае',
				'instructions' => 'По умолчанию — «Что делать при страховом случае».',
			],
			[
				'key' => 'field_insurance_claim_intro',
				'label' => 'Вводный текст',
				'name' => 'insurance_claim_intro',
				'type' => 'textarea',
				'rows' => 3,
				'new_lines' => 'br',
			],
			[
				'key' => 'field_insurance_claim_steps',
				'label' => 'Шаги',
				'name' => 'insurance_claim_steps',
				'type' => 'repeater',
				'layout' => 'block',
				'button_label' => 'Добавить шаг',
				'sub_fields' => [
					$fill_icons($icon_field('field_insurance_claim_step_icon')),
					[
						'key' => 'field_insurance_claim_step_title',
						'label' => 'Заголовок',
						'name' => 'title',
						'type' => 'text',
					],
					[
						'key' => 'field_insurance_claim_step_desc',
						'label' => 'Описание',
						'name' => 'description',
						'type' => 'textarea',
						'rows' => 3,
			...
			[
				'key' => 'field_insurance_claim_phone',
				'label' => 'Телефон сервисного центра',
				'name' => 'insurance_claim_phone',
				'type' => 'text',
				'instructions' => 'Показывается в блоке контакта сервисного центра. Пусто — блок не выводится.',
			],
			[
				'key' => 'field_insurance_claim_phone_note',
				'label' => 'Подпись к телефону',
				'name' => 'insurance_claim_phone_note',
				'type' => 'text',
				'placeholder' => 'Круглосуточно, звонок из-за границы',
			],

			// ── Почему через BSI ─────────────────────────────────────────
			[
				'key' => 'field_insurance_tab_why',
				'label' => 'Почему через нас',
				'type' => 'tab',
				'placement' => 'top',
			],
			[
				'key' => 'field_insurance_why_title',
				'label' => 'Заголовок блока',
				'name' => 'insurance_why_title',
				'type' => 'text',
				'placeholder' => 'Почему через BSI Group',
				'instructions' => 'По умолчанию — «Почему через BSI Group».',
			],
			[
				'key' => 'field_insurance_why_items',
				'label' => 'Пункты',
				'name' => 'insurance_why_items',
				'type' => 'repeater',
				'layout' => 'block',
				'button_label' => 'Добавить пункт',
				'sub_fields' => [
					$fill_icons($icon_field('field_insurance_why_icon')),
					[
						'key' => 'field_insurance_why_item_value',
						'label' => 'Цифра или короткое значение',
						'name' => 'value',
						'type' => 'text',
						'instructions' => 'Например «83 филиала». Можно оставить пустым.',
					],
					[
						'key' => 'field_insurance_why_item_title',
						'label' => 'Заголовок',
						'name' => 'title',
						'type' => 'text',
					],
					[
						'key' => 'field_insurance_why_item_desc',
						'label' => 'Описание',
						'name' => 'description',
						'type' => 'textarea',
						'rows' => 3,
