...
function bsi_register_education_acf_groups(): void
{
  ...
  acf_add_local_field_group([
    ...
    'fields' => [
      ...
      // Поля скрыты из админки — цены теперь всегда берутся на уровне программ
      // [
      //   'key' => 'field_education_price',
      //   'label' => 'Стоимость (старое поле, для обратной совместимости)',
      ...
      [
        'key' => 'field_education_is_group_arrival',
        'label' => 'Групповой заезд',
        'name' => 'is_group_arrival',
        'type' => 'true_false',
        'ui' => 1,
        'default_value' => 0,
        'instructions' => 'Если включено, школа будет отображаться при фильтрации «Групповой заезд» в каталоге.',
        'wrapper' => ['width' => '50'],
      ],
      [
      ...
      [
        ...
        'sub_fields' => [
          ...
          [
            ...
            'label' => 'Цена за неделю (старое поле)',
          ...
          [
            'key' => 'field_program_price_per_week_original',
            'label' => 'Исходная цена за неделю',
            'name' => 'program_price_per_week_original',
            'type' => 'number',
            'instructions' => 'Например: 50000, 1500 и т.д.',
            'step' => 0.01,
            'wrapper' => ['width' => '17'],
          ],
          [
            'key' => 'field_program_price_per_week_currency',
            'label' => 'Валюта программы',
            'name' => 'program_price_per_week_currency',
            'type' => 'select',
            'choices' => [
              'USD' => 'USD',
              'EUR' => 'EUR',
          ...
          [
            'key' => 'field_program_dates',
            'label' => 'Даты заселения',
            'name' => 'program_dates',
            'type' => 'textarea',
            'rows' => 5,
            'instructions' => 'Введите даты через запятую или с новой строки в формате ДД.ММ.ГГГГ. Прошедшие даты будут автоматически скрыты на сайте. Например: 21.07.2026, 30.08.2026',
            'placeholder' => '21.07.2026, 30.08.2026',
            'new_lines' => '',
            'wrapper' => ['width' => '100'],
          ],
          [
