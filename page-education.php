    ...
    <form class="education-filter ui-filters js-education-filter"
      ...
      <div class="education-filter__row">
        <div class="education-filter__field tours-filter__field">
          ...
          <select class="education-filter__select tours-filter__select"
                  name="country"
                  data-choice="single">
        ...
        <div class="education-filter__field tours-filter__field">
          <div class="tours-filter__label">Язык</div>
          <select class="education-filter__select tours-filter__select"
                  name="language"
                  data-choice="single">
        ...
        <div class="education-filter__field tours-filter__field">
          <div class="tours-filter__label">Программа</div>
          <select class="education-filter__select tours-filter__select"
                  name="program"
                  data-choice="single">
        ...
        <div class="education-filter__field tours-filter__field">
          <div class="tours-filter__label">Тип обучения</div>
          <select class="education-filter__select tours-filter__select"
                  name="type"
                  data-choice="single">
            <option value="">Показать все</option>
        ...
        <div class="education-filter__field tours-filter__field">
          <div class="tours-filter__label">Размещение</div>
          <select class="education-filter__select tours-filter__select"
                  name="accommodation"
                  data-choice="single">
            <option value="">Показать все</option>
        ...
        <div class="education-filter__field tours-filter__field">
          <div class="tours-filter__label">Возраст</div>
          <select class="education-filter__select tours-filter__select"
                  name="age"
                  data-choice="single">
            <option value="">Показать все</option>
        ...
        <div class="education-filter__field tours-filter__field">
          <div class="tours-filter__label">Продолжительность</div>
          <select class="education-filter__select tours-filter__select"
                  name="duration"
                  data-choice="single">
            <option value="">Показать все</option>
    ...
    <div class="education-page__list js-education-list">
      <?php if ($initial_query->have_posts()): ?>
        ...
        while ($initial_query->have_posts()):
          ...
          if (function_exists('get_field')) {
            // Цена берется только из программ, не из полей школы
            // Пытаемся из программ
            if (empty($price)) {
              ...
              if (!empty($education_programs)) {
                ...
                if (!empty($prices_data)) {
                  // Находим программу с минимальной ценой в рублях
                  ...
                  // Сохраняем информацию для передачи в data-attributes
                  // (будет использована в price_data_attrs ниже)
          ...
          if (!empty($price)) {
            ...
            if ($price_numeric > 0) {
              ...
              // Если есть информация об оригинальной цене (из программ)
              if (!empty($price_original) && !empty($price_currency)) {
