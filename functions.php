...
require get_template_directory() . '/inc/post-types/banner-second.php';
require get_template_directory() . '/inc/post-types/banner-third.php';
...
require get_template_directory() . '/custom-fields/pages/bsimice.php';
...
require get_template_directory() . '/custom-fields/insurance.php';
...
require get_template_directory() . '/inc/mail-lead-helpers.php';
require get_template_directory() . '/inc/requests/ajax-bsimice-form.php';
require get_template_directory() . '/inc/bsimice-menu-anchors.php';
require get_template_directory() . '/inc/requests/ajax-insurance-form.php';
...
require get_template_directory() . '/inc/services/currency-history.php';
